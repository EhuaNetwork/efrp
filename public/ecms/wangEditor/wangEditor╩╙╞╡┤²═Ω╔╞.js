...
*/
    ...
    Video.prototype = {
        ...
        _createInsertPanel: function _createInsertPanel() {
            ...
            var tabsConfig = [{
                title: '上传视频',
                tpl: '<div class="w-e-up-img-container"><div id="' + upTriggerVideoId + '" class="w-e-up-btn"><i class="w-e-icon-upload2"></i></div><div style="display:none;"><input id="' + upFileVideoId + '" type="file" multiple="multiple" accept="application/video/*"/></div></div>',events: [{
                    // 触发选择图片
...
// 原型
    Image.prototype = {
        ...
        _createEditPanel: function _createEditPanel() {
            ...
            var tabsConfig = [{
                title: '编辑图片',
                tpl: '<div>\n                    <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n                        <span style="float:left;font-size:14px;margin:4px 5px 0 5px;color:#333;">\u6700\u5927\u5BBD\u5EA6\uFF1A</span>\n                        <button id="' + width30 + '" class="left">30%</button>\n                        <button id="' + width50 + '" class="left">50%</button>\n                        <button id="' + width100 + '" class="left">100%</button>\n                    </div>\n                    <div class="w-e-button-container">\n                        <button id="' + delBtn + '" class="gray left">\u5220\u9664\u56FE\u7247</button>\n                    </dv>\n                </div><div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;"><input type="text" id="alt"><button id="' + addAltBtn + '" class="gray left">\u8bbe\u7f6e</button></div>',
                events: [{
                    selector: '#' + width30,
                    type: 'click',
                    fn: function fn() {
...
// 原型
    UploadImg.prototype = {
        ...
        insertLinkVideo: function insertLinkVideo(link) {
            ...
            var editor = this.editor;
            var config = editor.config;
            // editor.cmd.do('insertHTML', '<video src="' + link + '" style="max-width:100%;"/>');
            editor.cmd.do('insertHTML', `<video controls="" autoplay="" name="media"><source src="${link}" type="video/mp4"></video>`);
        ...
        uploadVideo: function uploadVideo(files) {
            ...
            var editor = this.editor;
            var config = editor.config;
            var uploadVideoServer = config.uploadImgServer;
